...
namespace NationDrugs.DrugWei.Admin.UcFiles
{
    public partial class Ucpreparation : System.Web.UI.UserControl
    {
        ...
        protected int ExcuteUpdate(int keyid)
        {
            ...
            par[0] = new SqlParameter("@pName", SqlDbType.NVarChar, 40); par[0].Value = CharTextRequired1.TextValue;
            par[1] = new SqlParameter("@about", SqlDbType.Text); par[1].Value = RichText1.TextValue;
      ...
      //Excute在插入操作之后能在 Session["keyppid"] = keyid;和隐藏的值 hid_keyid.Value = keyid.ToString().Trim();保留主键id
        protected int ExcuteInsert()
        {
            ...
            par[1] = new SqlParameter("@pName", SqlDbType.NVarChar, 40); par[1].Value = CharTextRequired1.TextValue;
            par[2] = new SqlParameter("@about", SqlDbType.Text); par[2].Value = RichText1.TextValue;
