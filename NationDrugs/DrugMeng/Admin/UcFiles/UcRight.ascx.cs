...
namespace NationDrugs.DrugMeng.Admin.UcFiles
{
    public partial class UcRight : System.Web.UI.UserControl
    {
        ...
        protected int ExcuteUpdate(int rightid)
        {
            ...
            par[4] = new SqlParameter("@rtname", SqlDbType.NVarChar, 30); par[4].Value = CharTextRequired1.TextValue;
            par[5] = new SqlParameter("@rtcontent", SqlDbType.Text); par[5].Value = RichText1.TextValue;
        ...
        protected int ExcuteInsert()
        {
            ...
            par[3] = new SqlParameter("@rtname", SqlDbType.NVarChar, 30); par[3].Value = CharTextRequired1.TextValue;
            par[4] = new SqlParameter("@rtcontent", SqlDbType.Text); par[4].Value = RichText1.TextValue;
