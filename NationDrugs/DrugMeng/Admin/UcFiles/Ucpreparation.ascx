<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Ucpreparation.ascx.cs" Inherits="NationDrugs.DrugMeng.Admin.UcFiles.Ucpreparation" %>
...
<ContentTemplate>
 ...
 <asp:Repeater ID="Rpter_person" runat="server" 
        onitemcommand="Rpter_person_ItemCommand" >
          ...
          <tr>
              <td colspan="2" style=" text-align :center;">
                  <asp:Button ID="btn_add" runat="server" onclick="btn_add_Click" Text="添加新记录" 
                      ValidationGroup="0" />
                  <asp:Button ID="bnt_savePreparation" runat="server" 
                      onclick="bnt_savePreparation_Click" Text="保存信息" Width="87px" />
                  <asp:Button ID="btn_back1" runat="server" onclick="btn_back1_Click" 
                      Text="&lt;&lt;上一步" ValidationGroup="0" />
                  <asp:Button ID="bnt_cancal" runat="server" onclick="bnt_cancal_Click" 
