<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UcUserNew.ascx.cs" Inherits="NationDrugs.DrugMeng.Admin.UcFiles.UcUserNew" %>
       ...
       <tr>
        ...
        <td bgcolor="white" colspan="10"  >
                ...
                <asp:SqlDataSource ID="SqlDataS_right" runat="server" 
                    ...
                    SelectCommand="SELECT * FROM [LeftParentMenu]"></asp:SqlDataSource>
           </td>
