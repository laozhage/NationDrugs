...
namespace NationDrugs.DrugMeng.Admin.UcFiles
{
    public partial class ucCharacter : System.Web.UI.UserControl
    {
        ...
        protected int ExcuteUpdate(int keyid)
        {
            ...
            par[1] = new SqlParameter("@cc14", SqlDbType.NVarChar, 30); par[1].Value = CharText14.TextValue;
            par[2] = new SqlParameter("@cc15", SqlDbType.NVarChar, 50); par[2].Value = CharText15.TextValue;
            par[3] = new SqlParameter("@cc16", SqlDbType.NVarChar, 50); par[3].Value = CharText16.TextValue;
            par[4] = new SqlParameter("@cc17", SqlDbType.NVarChar, 50); par[4].Value = CharText17.TextValue;
            par[5] = new SqlParameter("@cc18", SqlDbType.Text); par[5].Value = RichText18.TextValue;
            par[6] = new SqlParameter("@cc19", SqlDbType.NVarChar, 400); par[6].Value = RichText19.TextValue;
            par[7] = new SqlParameter("@cc20", SqlDbType.Text); par[7].Value = RichText20.TextValue;
