...
namespace NationDrugs.DrugMeng.Admin.UcFiles
{
    public partial class UcUserNew : System.Web.UI.UserControl
    {
        ...
        protected void DataBindGV()
        {
            ...
            try
            {
                DataTable dt = cuser.GetAllUserDatatable();
                gv.DataSource = dt;
                gv.DataBind();
            }
            catch
        ...
        protected void DataBindText(string userid)
        {
            ...
            try
            {
                ...
                if (dt.Rows.Count > 0)
                {
                    ...
                    txt_pass.Text = "";
                    DropDownList1.SelectedIndex = charTodi(dt.Rows[0]["Groupid"].ToString().Trim());
        ...
        public int ExcuteUpdate(int iuserid)
        {
            ...
            try
            {
                ...
                par[1] = new SqlParameter("@truename", SqlDbType.NVarChar, 40); par[1].Value = txt_tname.TextValue;
        ...
        protected int ExcuteInsert()
        {
            ...
            {
                par[0] = new SqlParameter("@Groupid", SqlDbType.Int); par[0].Value = Convert.ToInt32(DropDownList1.SelectedItem.Value.ToString().Trim());
                par[1] = new SqlParameter("@username", SqlDbType.NVarChar, 40); par[1].Value = UserGUID;
                par[2] = new SqlParameter("@truename", SqlDbType.NVarChar, 40); par[2].Value = txt_tname.TextValue;
