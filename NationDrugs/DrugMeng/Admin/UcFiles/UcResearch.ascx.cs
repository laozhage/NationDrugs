...
namespace NationDrugs.DrugMeng.Admin.UcFiles
{
    public partial class UcResearch : System.Web.UI.UserControl
    {
        ...
        protected int ExcuteUpdate(int keyid)
        {
            ...
            par[1] = new SqlParameter("@rsh21", SqlDbType.Text); par[1].Value = RichText21.TextValue;
            par[2] = new SqlParameter("@rsh22", SqlDbType.Text); par[2].Value = RichText22.TextValue;
            par[3] = new SqlParameter("@rsh23", SqlDbType.NVarChar, 50); par[3].Value = "";
            par[4] = new SqlParameter("@rsh24", SqlDbType.Text); par[4].Value = RichText24.TextValue;
            par[5] = new SqlParameter("@rsh25", SqlDbType.Text); par[5].Value = RichText25.TextValue;
            par[6] = new SqlParameter("@rsh26", SqlDbType.Text); par[6].Value = RichText26.TextValue;
            par[7] = new SqlParameter("@rsh27", SqlDbType.Text); par[7].Value = RichText27.TextValue;
            par[8] = new SqlParameter("@rsh28", SqlDbType.Text); par[8].Value = RichText28.TextValue;
            par[9] = new SqlParameter("@rsh29", SqlDbType.Text); par[9].Value = RichText29.TextValue;
            par[10] = new SqlParameter("@rsh30", SqlDbType.Text); par[10].Value = RichText30.TextValue;
            par[11] = new SqlParameter("@rsh31", SqlDbType.Text); par[11].Value = "";
