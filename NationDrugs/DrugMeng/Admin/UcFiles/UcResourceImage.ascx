<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UcResourceImage.ascx.cs" Inherits="NationDrugs.DrugMeng.Admin.UcFiles.UcResourceImage" %>

<%@ Register src="../../Ucshared/CharTextRequired.ascx" tagname="CharTextRequired" tagprefix="uc1" %>
