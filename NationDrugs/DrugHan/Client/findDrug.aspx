<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="findDrug.aspx.cs" Inherits="NationDrugs.DrugHan.Client.findDrug" %>
...
<body>
    <form id="form1" runat="server">
     <div>
       <table cellpadding="4" cellspacing="0" border="1" width="100%" 
        style="border-collapse: collapse; font-size:10pt;  font-family:Microsoft Himalaya; background-color:#ebf7ff; border-color:#588fc7;" 
        bordercolor="#588fc7">
        <tr>
    ...
    <tr>
        ...
        <td bgcolor="white" style =" width:90%;">        
             ...
             Width="107px" />
                  ...
                  <asp:GridView ID="gv" runat="server" AllowPaging="True"  AutoGenerateColumns="False"
                   Font-Size="11pt"    RowStyle-Height = "10pt" 
                   ...
                   <RowStyle Height="10pt" BackColor = "White" ></RowStyle>
