<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UcUserNew.ascx.cs" Inherits="NationDrugs.DrugHan.Admin.UcFiles.UcUserNew" %>
       ...
       <tr>
        ...
        <td bgcolor="white" colspan="10"  >
                ...
                <asp:SqlDataSource ID="SqlDataS_right" runat="server" 
                    ...
                    <SelectParameters>
                        <asp:ControlParameter ControlID="DropDownList1" Name="ParentMenuID" 
