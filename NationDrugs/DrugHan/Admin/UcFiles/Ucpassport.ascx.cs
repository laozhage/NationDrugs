    ...
    public partial class Ucpassport : System.Web.UI.UserControl
    {
        ...
        public void DataBindText(string drugid)
        {
            ...
            try
            {
                ...
                if (dt.Rows.Count > 0)
                {
                    CharText1.TextValue = dt.Rows[0]["nationName"].ToString().Trim();
                    CharText2.TextValue = dt.Rows[0]["transltName"].ToString().Trim();
                    CharText3.TextValue = dt.Rows[0]["name"].ToString().Trim();
        ...
        public int ExcuteUpdate(int idrugid)//有问题
        {
            ...
            par[0] = new SqlParameter("@nationName", SqlDbType.NText); par[0].Value = CharText1.TextValue;
            par[1] = new SqlParameter("@transltName", SqlDbType.NText); par[1].Value = CharText2.TextValue;
            par[2] = new SqlParameter("@name", SqlDbType.NText); par[2].Value = CharText3.TextValue;
            par[3] = new SqlParameter("@position", SqlDbType.NText); par[3].Value = CharText4.TextValue;
            par[4] = new SqlParameter("@channel", SqlDbType.NText); par[4].Value = CharText5.TextValue;
            par[5] = new SqlParameter("@effect", SqlDbType.NText); par[5].Value = CharText6.TextValue;
            par[6] = new SqlParameter("@func", SqlDbType.NText); par[6].Value = CharText7.TextValue;
            par[7] = new SqlParameter("@usef", SqlDbType.NText); par[7].Value = CharText8.TextValue;
            par[8] = new SqlParameter("@Observe", SqlDbType.NText); par[8].Value = CharText9.TextValue;
            par[9] = new SqlParameter("@standard", SqlDbType.NText); par[9].Value = CharText10.TextValue;
            par[10] = new SqlParameter("@classify", SqlDbType.NText); par[10].Value = CharText12.TextValue;
            par[11] = new SqlParameter("@subjectno", SqlDbType.NVarChar, 100); par[11].Value = CharText13.TextValue;
        ...
        public int ExcuteInsert()
        {
            ...
            par[11] = new SqlParameter("@classify", SqlDbType.NText); par[11].Value = CharText12.TextValue;
            par[12] = new SqlParameter("@subjectno", SqlDbType.NVarChar, 100); par[12].Value = CharText13.TextValue;
            
            par[13] = new SqlParameter("@bdel", SqlDbType.Bit); par[13].Value = 1;
            par[14] = new SqlParameter("@ppbak1", SqlDbType.NVarChar, 100); par[14].Value = uinfor.Groupid;
            par[15] = new SqlParameter("@ppbak2", SqlDbType.NVarChar, 100); par[15].Value = string.Empty;         
