    ...
    public partial class UcHeredity : System.Web.UI.UserControl
    {
        ...
        protected int ExcuteInsert()
        {
            ...
            if (rbtn_41.SelectedIndex == 0)
            {
                ...
                par[2] = new SqlParameter("@hdt42", SqlDbType.NVarChar, 400);   par[2].Value = CharText1.TextValue;
                par[3] = new SqlParameter("@hdt43", SqlDbType.NVarChar, 50);    par[3].Value = rbtn_43.SelectedItem.Value;
                par[4] = new SqlParameter("@hdt44", SqlDbType.NVarChar, 500);   par[4].Value = rbtn_44.SelectedIndex == 4 ? rbtn_44.SelectedItem.Value + ":" + txt_44.Text.ToString().Trim() : rbtn_44.SelectedItem.Value;
                par[5] = new SqlParameter("@hdt45", SqlDbType.NVarChar, 50);    par[5].Value = CharText2.TextValue;
                par[6] = new SqlParameter("@hdt46", SqlDbType.NVarChar, 200);   par[6].Value = CharText3.TextValue;
                par[7] = new SqlParameter("@hdt47", SqlDbType.Date);            par[7].Value = IsDate(txt_date1.Text.ToString().Trim());
                par[8] = new SqlParameter("@hdt48", SqlDbType.NVarChar, 200);   par[8].Value = CharText5.TextValue;
                par[9] = new SqlParameter("@hdt49", SqlDbType.Int);             par[9].Value = isInt(CharText6.TextValue);
                par[10] = new SqlParameter("@hdt50", SqlDbType.NVarChar, 1000); par[10].Value = CharText7.TextValue;
                par[11] = new SqlParameter("@hdt51", SqlDbType.NVarChar, 500);  par[11].Value = CharText8.TextValue;
                par[12] = new SqlParameter("@hdt52", SqlDbType.NVarChar, 500);  par[12].Value = CharText9.TextValue;
                par[13] = new SqlParameter("@hdt53", SqlDbType.NVarChar, 500);  par[13].Value = CharText10.TextValue;
                par[14] = new SqlParameter("@hdt54", SqlDbType.Float);          par[14].Value = IsFloat(CharText11.TextValue.ToString().Trim());
                par[15] = new SqlParameter("@hdt55", SqlDbType.NVarChar, 500);  par[15].Value = CharText12.TextValue;
                ...
                par[19] = new SqlParameter("@hdt59", SqlDbType.NVarChar, 500);  par[19].Value = CharText14.TextValue;
                par[20] = new SqlParameter("@hdt60", SqlDbType.NVarChar, 50);   par[20].Value = rbtn_60.SelectedItem.Value;
                par[21] = new SqlParameter("@hdt61", SqlDbType.NVarChar, 500);  par[21].Value = rbtn_61.SelectedIndex == 5 ? rbtn_61.SelectedItem.Value + ":" + txt_61.Text.ToString().Trim() : rbtn_61.SelectedItem.Value;
                par[22] = new SqlParameter("@htd62", SqlDbType.NVarChar, 500);  par[22].Value = rbtn_62.SelectedIndex == 6 ? rbtn_62.SelectedItem.Value + ":" + txt_62.Text.ToString().Trim() : rbtn_62.SelectedItem.Value;
                par[23] = new SqlParameter("@htd63", SqlDbType.NVarChar, 500);  par[23].Value = rbtn_63.SelectedIndex == 4 ? rbtn_63.SelectedItem.Value + ":" + txt_63.Text.ToString().Trim() : rbtn_63.SelectedItem.Value;
                par[24] = new SqlParameter("@htd64", SqlDbType.NVarChar, 500);  par[24].Value = rbtn_64.SelectedIndex == 5 ? rbtn_64.SelectedItem.Value + ":" + txt_64.Text.ToString().Trim() : rbtn_64.SelectedItem.Value;
                par[25] = new SqlParameter("@htd65", SqlDbType.NVarChar, 50);   par[25].Value = rbtn_65.SelectedItem.Value;
                par[26] = new SqlParameter("@htd66", SqlDbType.NVarChar, 800);  par[26].Value = CharText15.TextValue;
            ...
            else
            {
                ...
                par[0] = new SqlParameter("@drugid", SqlDbType.Int);         par[0].Value = idrugid;
                par[1] = new SqlParameter("@hdt41", SqlDbType.NVarChar, 10); par[1].Value = rbtn_41.SelectedItem.Value;
                par[2] = new SqlParameter("@hdt42", SqlDbType.NVarChar, 400); par[2].Value = ""; 
                par[3] = new SqlParameter("@hdt43", SqlDbType.NVarChar, 50); par[3].Value = "";
                par[4] = new SqlParameter("@hdt44", SqlDbType.NVarChar, 500); par[4].Value = "";
                par[5] = new SqlParameter("@hdt45", SqlDbType.NVarChar, 50); par[5].Value = "";
                par[6] = new SqlParameter("@hdt46", SqlDbType.NVarChar, 200); par[6].Value = "";
                par[7] = new SqlParameter("@hdt47", SqlDbType.Date);         par[7].Value = DateTime.Now.ToShortDateString();
                par[8] = new SqlParameter("@hdt48", SqlDbType.NVarChar, 200); par[8].Value = "";
                par[9] = new SqlParameter("@hdt49", SqlDbType.Int);          par[9].Value = 0;
                par[10] = new SqlParameter("@hdt50", SqlDbType.NVarChar, 1000); par[10].Value = "";
                par[11] = new SqlParameter("@hdt51", SqlDbType.NVarChar, 500); par[11].Value = "";
                par[12] = new SqlParameter("@hdt52", SqlDbType.NVarChar, 500); par[12].Value = "";
                par[13] = new SqlParameter("@hdt53", SqlDbType.NVarChar, 500); par[13].Value = "";
                par[14] = new SqlParameter("@hdt54", SqlDbType.Float);        par[14].Value = 0;
                par[15] = new SqlParameter("@hdt55", SqlDbType.NVarChar, 500); par[15].Value = "";
                ...
                par[19] = new SqlParameter("@hdt59", SqlDbType.NVarChar, 500); par[19].Value = "";
                par[20] = new SqlParameter("@hdt60", SqlDbType.NVarChar, 50); par[20].Value = "";
                par[21] = new SqlParameter("@hdt61", SqlDbType.NVarChar, 500); par[21].Value = "";
                par[22] = new SqlParameter("@htd62", SqlDbType.NVarChar, 500); par[22].Value = "";
                par[23] = new SqlParameter("@htd63", SqlDbType.NVarChar, 500); par[23].Value = "";
                par[24] = new SqlParameter("@htd64", SqlDbType.NVarChar, 500); par[24].Value = "";
                par[25] = new SqlParameter("@htd65", SqlDbType.NVarChar, 50); par[25].Value = "";
                par[26] = new SqlParameter("@htd66", SqlDbType.NVarChar, 800); par[26].Value = "";
        ...
        protected int ExcuteUpdate(int hdid)
         {
             ...
             else
             {
                 //把参数全都设置为空
                 #region 给参数提供数字
                 par[0] = new SqlParameter("@drugid", SqlDbType.Int);
                 par[1] = new SqlParameter("@hdt41", SqlDbType.NVarChar, 10);
                 par[2] = new SqlParameter("@hdt42", SqlDbType.NVarChar, 400);
                 par[3] = new SqlParameter("@hdt43", SqlDbType.NVarChar, 50);
                 par[4] = new SqlParameter("@hdt44", SqlDbType.NVarChar, 500);
                 par[5] = new SqlParameter("@hdt45", SqlDbType.NVarChar, 50);
                 par[6] = new SqlParameter("@hdt46", SqlDbType.NVarChar, 200);
                 par[7] = new SqlParameter("@hdt47", SqlDbType.Date);
                 par[8] = new SqlParameter("@hdt48", SqlDbType.NVarChar, 200);
                 par[9] = new SqlParameter("@hdt49", SqlDbType.Int);
                 par[10] = new SqlParameter("@hdt50", SqlDbType.NVarChar, 1000);
                 par[11] = new SqlParameter("@hdt51", SqlDbType.NVarChar, 500);
                 par[12] = new SqlParameter("@hdt52", SqlDbType.NVarChar, 500);
                 par[13] = new SqlParameter("@hdt53", SqlDbType.NVarChar, 500);
                 par[14] = new SqlParameter("@hdt54", SqlDbType.Float);
                 par[15] = new SqlParameter("@hdt55", SqlDbType.NVarChar, 500);
                 par[16] = new SqlParameter("@hdt56", SqlDbType.Date);
                 par[17] = new SqlParameter("@hdt57", SqlDbType.NVarChar, 50);
                 par[18] = new SqlParameter("@hdt58", SqlDbType.NVarChar, 50);
                 par[19] = new SqlParameter("@hdt59", SqlDbType.NVarChar, 500);
                 par[20] = new SqlParameter("@hdt60", SqlDbType.NVarChar, 50);
                 par[21] = new SqlParameter("@hdt61", SqlDbType.NVarChar, 500);
                 par[22] = new SqlParameter("@htd62", SqlDbType.NVarChar, 500);
                 par[23] = new SqlParameter("@htd63", SqlDbType.NVarChar, 500);
                 par[24] = new SqlParameter("@htd64", SqlDbType.NVarChar, 500);
                 par[25] = new SqlParameter("@htd65", SqlDbType.NVarChar, 50);
                 par[26] = new SqlParameter("@htd66", SqlDbType.NVarChar, 800);
                 par[27] = new SqlParameter("@htd67", SqlDbType.NVarChar, 50);
                 par[28] = new SqlParameter("@hdid", SqlDbType.Int);               
                 par[0].Value = Convert.ToInt32(hid_drugid.Value);
                 par[1].Value = rbtn_41.SelectedItem.Value;
                 par[2].Value = "";
                 par[3].Value = "";
                 par[4].Value = "";
                 par[5].Value = "";
                 par[6].Value = "";
                 par[7].Value = DateTime.Now.ToShortDateString();
                 par[8].Value = "";
                 par[9].Value = 0;
                 par[10].Value = "";
                 par[11].Value = "";
                 ...
                 par[14].Value = 0;
                 par[15].Value = "";
                 par[16].Value = DateTime.Now.ToShortDateString();
                 par[17].Value = "";
                 par[18].Value = "";
                 par[19].Value = "";
                 par[20].Value = "";
