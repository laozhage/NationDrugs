<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UcHeredity.ascx.cs" Inherits="NationDrugs.DrugZang.Admin.UcFiles.UcHeredity" %>
<%@ Register src="../../Ucshared/CharTextRequired.ascx" tagname="CharTextRequired" tagprefix="uc3" %><%@ Register src="../../Ucshared/CharText.ascx" tagname="CharText" tagprefix="uc1" %><%@ Register src="../../Ucshared/Ulable.ascx" tagname="Ulable" tagprefix="uc2" %><%@ Register src="../../Ucshared/RichText.ascx" tagname="RichText" tagprefix="uc4" %><%@ Register src="../../Ucshared/DigitalOnlyTxt.ascx" tagname="DigitalOnlyTxt" tagprefix="uc6" %><%@ Register src="../../Ucshared/UcCalendar.ascx" tagname="UcCalendar" tagprefix="uc5" %><%@ Register src="../../Ucshared/FloatDigitalOnlyText.ascx" tagname="FloatDigitalOnlyText" tagprefix="uc7" %><%@ Register src="../../Ucshared/latitudeOnlyText.ascx" tagname="latitudeOnlyText" tagprefix="uc8" %>
...
<link href="Popwindows.css" rel="stylesheet" type="text/css" />
   ...
   <table cellpadding="4" cellspacing="0" border="1" width="100%" 
        style="border-collapse: collapse; font-size:14pt; background-color:#e7eaf1; border-color:#588fc7;" 
        bordercolor="#588fc7">
        <tr>
     ...
     <tr>
        ...
        <td bgcolor="white" style =" width:70%;" colspan = "3"  >
            <table>
               <tr>
                <td>
                    <asp:RadioButtonList ID="rbtn_41" runat="server"  CssClass ="rbtnHima"
        ...
        <td bgcolor="white" style =" width:75%;" colspan = "3"  >
                <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                    ...
                    RepeatDirection="Horizontal" onselectedindexchanged="rbtn_44_SelectedIndexChanged">
                        ...
                        <td>
                             <asp:TextBox ID="txt_44" runat="server" Enabled="False" CssClass ="txtHima"></asp:TextBox>
      ...
      <tr>
       ...
       <tr>
                ...
                <ContentTemplate>
                 <table>
                  <tr>
                    ...
                    <td>
                    <asp:TextBox ID="txt_61"  CssClass ="txtHima" runat="server" Enabled="False"></asp:TextBox>
                ...
                <ContentTemplate>
                  <table>
                    <tr>
                      ...
                      <td>
                       <asp:TextBox ID="txt_62" CssClass ="txtHima" runat="server" Enabled="False"></asp:TextBox>
                ...
                <ContentTemplate>
                   <table>
                      <tr>
                        ...
                        <td>
                            <asp:TextBox ID="txt_63" CssClass ="txtHima" runat="server" Enabled="False"></asp:TextBox>
             ...
             <ContentTemplate>
                   <table>
                      <tr>
                        ...
                        <td>
                            <asp:TextBox ID="txt_64" CssClass ="txtHima" runat="server" Enabled="False" EnableTheming="True"></asp:TextBox>
        ...
        <td align = "center" colspan="4" >
                <asp:Button ID="btn_save" runat="server" Text="保存信息"  CssClass ="btnHima"  Width="92px" onclick="btn_save_Click" 
                   />
                <asp:Button ID="btn_back7" runat="server" Text="&lt;&lt;上一步" Width="96px"  CssClass ="btnHima"
                    onclick="btn_back7_Click" ValidationGroup="1" 
                     />
                <asp:Button ID="btn_next7" runat="server" Text="下一步&gt;&gt;" Width="96px"  CssClass ="btnHima"
