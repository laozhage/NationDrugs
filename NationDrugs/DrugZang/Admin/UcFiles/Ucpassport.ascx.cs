...
namespace NationDrugs.DrugZang.Admin.UcFiles
{
    public partial class Ucpassport : System.Web.UI.UserControl
    {
        ...
        public int ExcuteUpdate(int idrugid)//有问题
        {
            ...
            par[0] = new SqlParameter("@nationName", SqlDbType.NText);      par[0].Value =Server.UrlEncode( CharText1.TextValue);
            par[1] = new SqlParameter("@transltName", SqlDbType.NText);     par[1].Value =Server.UrlEncode( CharText2.TextValue);
            par[2] = new SqlParameter("@name", SqlDbType.NText);            par[2].Value =Server.UrlEncode( CharText3.TextValue);
        ...
        public int ExcuteInsert()
        {
            ...
            par[14] = new SqlParameter("@ppbak1", SqlDbType.NVarChar, 100); par[14].Value = groupid;
