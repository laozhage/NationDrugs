<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UcUserNew.ascx.cs" Inherits="NationDrugs.DrugZang.Admin.UcFiles.UcUserNew" %>


<%@ Register src="../../../DrugZang/Ucshared/Ulable.ascx" tagname="Ulable" tagprefix="uc1" %>
...
<link href="Popwindows.css" rel="stylesheet" type="text/css" />
    ...
    <table cellpadding="4" cellspacing="0" border="1" width="100%" 
      ...
      <tr>
       ...
       <tr>
        <td style =" width:10%;" align = 用户权限:</td>
